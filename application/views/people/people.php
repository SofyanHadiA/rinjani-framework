...
<div class="row">
	<div class="col-md-12">
		<div class="box">
			...
			<div class="row">
				<div class="col-sm-6 ">					
					...
					<img src='<?php echo base_url()?>images/spinner_small.gif' alt='spinner' id='spinner' class="pull-left hide" />
					</form>
				</div>
		...
		*/
		...
		<div class="box-body">	
			<div >
				<a href="<?php echo "$controller_name/delete" ?>" class="btn btn-sm btn-danger">
					<i class="fa fa-trash"></i> 
					<?php echo $this->lang->line("common_delete")?>
				</a>
				<button class="btn btn-sm btn-success" id="email">
